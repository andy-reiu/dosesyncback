...
-- Profile
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (1, 1, 1, 'Technician', '12345678901', 'John', 'Doe', 'john.doe@example.com', '555-1000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (2, 2, 1, 'Administrator', '12345678902', 'Jane', 'Smith', 'jane.smith@example.com', '555-2000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (3, 3, 1, 'Observer', '12345678903', 'Bob', 'Brown', 'bob.brown@example.com', '555-3000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (4, 4, 1, 'Technician', '12345678904', 'Olga', 'Ivanova', 'olga@example.com', '555-4000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (5, 5, 1, 'Technician', '12345678905', 'Andy', 'Miller', 'andy@example.com', '555-5000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');
INSERT INTO dosesync.profile (id, user_id, hospital_id, occupation, national_id, first_name, last_name, email, phone_number, created_at, updated_at) VALUES (6, 6, 1, 'Technician', '12345678906', 'Kevin', 'Wang', 'kevin@example.com', '555-6000', '2025-05-16 13:24:38.029110', '2025-05-16 13:24:38.029110');

-- user-1-profile-image
INSERT INTO dosesync.user_image (id, profile_id, data) VALUES (1, 1, E'\\x89504E470D0A1A0A');
...
-- Machine
INSERT INTO dosesync.machine (id, name, serial_number, description) VALUES (default, 'Karl100', 'SN-DC-3000', 'High-precision dose injector');
